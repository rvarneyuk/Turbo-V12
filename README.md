...
The playfield now spans a full 1920×1080 window, and every sprite—from the Peugeot and rival traffic to the start-line crew and cones—has been redrawn at double resolution for chunkier, more detailed pixel art with obvious headlights, wheel arches, and tail lamps. The soot stream was also reworked so the bad-tune diesel coughs darker, puffier smoke directly out of its rear pipes instead of the nose.
